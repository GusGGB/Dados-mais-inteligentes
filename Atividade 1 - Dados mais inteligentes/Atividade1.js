...
var cidades;
cidades = gulliver.split("*");
console.log(cidades);
var cidade1 = cidades[1];
console.log(cidade1);
var cidade2 = cidades[3];
console.log(cidade2);
var cidade3 = cidades[5];
console.log(cidade3);
alert(`As cidades avaliadas são ${cidades[1]}, ${cidades[3]} e ${cidades[5]}`);

var roteiros;
roteiros = gulliver.split("#")
console.log(roteiros);
var roteiroSP = roteiros[1].split("<br>");
console.log(roteiroSP);
var roteiroLV = roteiros[4].split("<br>");
console.log(roteiroLV);
var roteiroMC = roteiros[7].split("<br>");
console.log(roteiroMC);
alert(`O roteiro A de ${cidades[1]} é ${roteiros[1].split("<br>")};\n O roteiro A de ${cidades[3]} é ${roteiros[4].split("<br>")};\n O roteiro A de ${cidades[5]} é ${roteiros[7].split("<br>")}`);

var numRoteiro = []
for (i = 0; i < roteiros.length; i++) {
    numRoteiro.push(roteiros[i].split(";").length)
}
alert(`O roteiro A de ${cidades[1]} tem ${numRoteiro[1]} lugares;\n O roteiro A de ${cidades[3]} tem ${numRoteiro[1]} lugares;\n O roteiro A de ${cidades[5]} tem ${numRoteiro[2]} lugares`);

var centro;
centro = gulliver.split("Região: ");
console.log(centro);
var centroSP = centro[2];
console.log(centroSP);
alert(`São os pontos turísticos de São Paulo no ${centro[2].split("#Roteiro C |")}`);

var downtown;
downtown = gulliver.split("Região: ");
console.log(downtown);
var downtownLV = downtown[5];
console.log(downtownLV);
alert(`São os pontos turísticos de Las Vegas em ${downtown[5].split("#Roteiro C |")}`);